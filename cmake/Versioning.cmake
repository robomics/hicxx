...
set(HICXX_PROJECT_VERSION_MAJOR 0)
set(HICXX_PROJECT_VERSION_MINOR 0)
set(HICXX_PROJECT_VERSION_PATCH 1)
set(HICXX_PROJECT_VERSION_SUFFIX "")

option(HICXX_ENABLE_GIT_VERSION_TRACKING "Retrieve project version and metadata from git" ON)

if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git" AND HICXX_ENABLE_GIT_VERSION_TRACKING)
  message(WARNING "-- Unable to find .git/ under \"${CMAKE_CURRENT_SOURCE_DIR}\". Setting -DHICXX_ENABLE_GIT_VERSION_TRACKING=OFF")
  set(HICXX_ENABLE_GIT_VERSION_TRACKING OFF CACHE FORCE)
endif()
...
function(ConfigureVersioning input_config_folder output_config_folder)
  ...
  if(HICXX_ENABLE_GIT_VERSION_TRACKING)
    # cmake-format: off
